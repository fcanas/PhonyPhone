...
// PhonyPhone
#define COCOAPODS_POD_AVAILABLE_PhonyPhone
#define COCOAPODS_VERSION_MAJOR_PhonyPhone 0
#define COCOAPODS_VERSION_MINOR_PhonyPhone 1
#define COCOAPODS_VERSION_PATCH_PhonyPhone 0
